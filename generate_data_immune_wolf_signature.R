# Modified from https://github.com/rwsayaman/TCGA_PanCancer_Immune_Genetics/blob/main/Code/Immune_Traits/Wolf_Amara/Calculate_Wolf_Signatures.R
...
ExprData <- as.matrix(read.delim("data/immune/processed_input/processed_symbol_all_expr.tsv", row.names=1))
dim(ExprData)
range(ExprData)
...
### Gene Signatures
load("data/immune/processed_input/wolf/comparative_immuneSigs_geneLists4.rda")
head(sigs1_2_eg2)
length(sigs1_2_eg2)
...
save(ExprData.WolfSignatures.meanCtrScl, file="data/immune/raw_output/wolf/ExprData.WolfSignatures.meanCtrScl.RData")
save(ExprData.WolfSignatures.mdCtrScl, file="data/immune/raw_output/wolf/ExprData.WolfSignatures.mdCtrScl.RData")
...
save(ExprData.WolfSignatures.GeneSYM, file="data/immune/raw_output/wolf/ExprData.WolfSignatures.GeneSYM.RData")
